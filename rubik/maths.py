class Point(object):
    ...
    def __str__(self):
        """return self coordinate to tuple"""
    ...
    def __mul__(self, other):
        """return self*other(constant) coordinate"""
        return Point(self.x * other, self.y * other, self.z * other)

    def dot(self, other):
        """return self, other dot product """
        return self.x * other.x + self.y * other.y + self.z * other.z

    def cross(self, other):
        """return self, other cross product"""
